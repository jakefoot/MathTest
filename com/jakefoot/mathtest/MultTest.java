...
public class MultTest extends JFrame
{
	/**
	 * 
	 */
	...
	public MultTest(int qty, int min, int max)
	{		
		super(String.format("%d Problem Multiplication Test", qty));
		setSize(475, 250);		
		setResizable(false);
	...
	private void evaluateAnswer(int given)
	{
		if (ans == given)
		{
			...
			msg.setText("Correct!  " + num1 + " X " + num2 + " = " + ans);				
		}
		else
		{
			msg.setForeground(Color.RED);
			msg.setText("Incorrect.  " + num1 + " X " + num2 + " = " + ans);
		}
	}	
