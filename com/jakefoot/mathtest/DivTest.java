...
public class DivTest extends JFrame
{
	/**
	 * 
	 */
	...
	public DivTest(int qty, int min, int max)
	{		
		super(String.format("%d Problem Division Test", qty));
		setSize(475, 250);		
		setResizable(false);
	...
	{		
		...
		num2 = getFactor();
		ans = num1 * num2;
		num1field.setText(String.format("%d", ans));
	...
	private void evaluateAnswer(int given)
	{
		if (num1 == given)
		{
			...
			msg.setText("Correct!  " + ans + " / " + num2 + " = " + num1);				
		}
		else
		{
			msg.setForeground(Color.RED);
			msg.setText("Incorrect.  " + ans + " / " + num2 + " = " + num1);
		}
	}	
